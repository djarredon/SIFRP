...
public class BenefitList {
    ...
    private String print(Benefit benefit) {
        if (benefit == null)
            return "";
        return benefit.getName() + "\n"
                + benefit.getShortDescription()
                + "\n----------\n"
                + print(benefit.getNext());
    }
    ...
    public void insert(Benefit toInsert) {
        ...
        if (head == null)
            ...
            Benefit current = head;
            Benefit trail = current;
            while (current != null && toInsert.getName().compareToIgnoreCase(current.getName()) > 0) {
                trail = current;
                current = current.getNext();
            }
            if (current == null) {
                trail.setNext(toInsert);
            }
            else {
...
class Benefit {
    ...
    Benefit() {
        name = requirement = shortDescription = longDescription = null;
        next = null;
    }
    ...
    public Benefit Worldly() {
        return new Benefit("Worldly",
                "none",
    ...
    public Benefit WeaponSavant() {
        return new Benefit("Weapon Savant",
    ...
    public Benefit WeaponMastery() {
        return new Benefit("Weapon Mastery",
                "none",
    ...
    public Benefit Wealthy() {
        return new Benefit("Wealthy",
                "none",
    ...
    public Benefit WaterDancerIII() {
        return new Benefit("Water Dancer III",
    ...
    public Benefit WaterDancerII() {
        return new Benefit("Water Dancer II",
    ...
    public Benefit WaterDancerI() {
        return new Benefit("Water Dancer I",
    ...
    public Benefit WargDreams() {
        return new Benefit("Warg Dreams",
    ...
    public Benefit TripleShot() {
        return new Benefit("Triple Shot",
    ...
    public Benefit Treacherous() {
        return new Benefit("Treacherous",
                "none",
    ...
    public Benefit Trade() {
        return new Benefit("Trade",
                "none",
    ...
    public Benefit TourneyKnight() {
        return new Benefit("Tourney Knight",
    ...
    public Benefit TerrainSpecialist() {
        return new Benefit("Terrain Specialist",
                "Requires Survival 4",
    ...
    public Benefit Talented() {
        return new Benefit("Talented",
                "none",
    ...
    public Benefit Stubborn() {
        return new Benefit("Stubborn",
    ...
    public Benefit Sponsor() {
        return new Benefit("Sponsor",
                "none",
    ...
    public Benefit SpearFighterIII() {
        return new Benefit("Spear Fighter III",
    ...
    public Benefit SpearFighterII() {
        return new Benefit("Spear Fighter II",
    ...
    public Benefit SpearFighterI() {
        return new Benefit("Spear Fighter I",
    ...
    public Benefit Skinchanger() {
        return new Benefit("Skinchanger",
    ...
    public Benefit Sinister() {
        return new Benefit("Sinister",
                "none",
    ...
    public Benefit ShortBladeFighterIII() {
        return new Benefit("Short Blade Fighter III",
    ...
    public Benefit ShortBladeFighterII() {
        return new Benefit("Short Blade Fighter II",
    ...
    public Benefit ShortBladeFighterI() {
        return new Benefit("Short Blade Fighter I",
    ...
    public Benefit ShieldMastery() {
        return new Benefit("Shield Mastery",
    ...
    public Benefit Respected() {
        return new Benefit("Respected",
    ...
    public Benefit Polyglot() {
        return new Benefit("Polyglot",
    ...
    public Benefit PolearmFighterIII() {
        return new Benefit("Polearm Fighter III",
    ...
    public Benefit PolearmFighterII() {
        return new Benefit("Polearm Fighter II",
    ...
    public Benefit PolearmFighterI() {
        return new Benefit("Polearm Fighter I",
    ...
    public Benefit Pious() {
        return new Benefit("Pious",
                "Requires Will 3 (Dedication 1B)",
    ...
    public Benefit NightEyes() {
        return new Benefit("Night Eyes",
                "none",
    ...
    public Benefit Mummer() {
        return new Benefit("Mummer",
    ...
    public Benefit MiracleWorker() {
        return new Benefit("Miracle Worker",
                "Requires Healing 4",
    ...
    public Benefit MasterOfRavens() {
        return new Benefit("Master Of Ravens",
    ...
    public Benefit Massive() {
        return new Benefit("Massive",
    ...
    public Benefit ManOfTheKingsguard() {
        return new Benefit("Man Of The Kingsguard",
                "Requires Sponsor",
    ...
    public Benefit Magnetic() {
        return new Benefit("Magnetic",
    ...
    public Benefit Maester() {
        return new Benefit("Maester",
    ...
    public Benefit Lucky() {
        return new Benefit("Lucky",
                "none",
    ...
    public Benefit LongBladeFighterIII() {
        return new Benefit("Long Blade Fighter III",
                ...
                "When you wield a long blade in combat, you may sacrifice all of your\n" +
                        ...
                        "Destiny Point can aBenefit gaining this quality.");

    }

    public Benefit LongBladeFighterII() {
        return new Benefit("Long Blade Fighter II",
    ...
    public Benefit LongBladeFighterI() {
        return new Benefit("Long Blade Fighter I",
    ...
    public Benefit LeaderOfMen() {
        return new Benefit("Leader Of Men",
    ...
    public Benefit Landed() {
        return new Benefit("Landed",
                "Requires Sponsor",
    ...
    public Benefit KnowledgeFocusAlchemy() {
        return new Benefit("Knowledge Focus [Alchemy]",
    ...
    public Benefit KnowledgeFocusArchitecture() {
        return new Benefit("Knowledge Focus [Architecture]",
                "Requires Knowledge 4",
                "You are an expert on a particular subject.",
                "Select one of the following areas of expertise—alchemy, architecture,\n" +
                        "astronomy, geography, heraldry, history and legends, magic, nature, religion,\n" +
    ...
    public Benefit KnowledgeFocusAstronomy() {
        return new Benefit("Knowledge Focus [Astronomy]",
                "Requires Knowledge 4",
                "You are an expert on a particular subject.",
                "Select one of the following areas of expertise—alchemy, architecture,\n" +
                        "astronomy, geography, heraldry, history and legends, magic, nature, religion,\n" +
    ...
    public Benefit KnowledgeFocusGeography() {
        return new Benefit("Knowledge Focus [Geography]",
                "Requires Knowledge 4",
                "You are an expert on a particular subject.",
                "Select one of the following areas of expertise—alchemy, architecture,\n" +
                        "astronomy, geography, heraldry, history and legends, magic, nature, religion,\n" +
    ...
    public Benefit KnowledgeFocusHeraldry() {
        return new Benefit("Knowledge Focus [Heraldry]",
                "Requires Knowledge 4",
                "You are an expert on a particular subject.",
                "Select one of the following areas of expertise—alchemy, architecture,\n" +
                        "astronomy, geography, heraldry, history and legends, magic, nature, religion,\n" +
    ...
    public Benefit KnowledgeFocusHistory() {
        return new Benefit("Knowledge Focus [History]",
                "Requires Knowledge 4",
                "You are an expert on a particular subject.",
                "Select one of the following areas of expertise—alchemy, architecture,\n" +
                        "astronomy, geography, heraldry, history and legends, magic, nature, religion,\n" +
    ...
    public Benefit KnowledgeFocusLegends() {
        return new Benefit("Knowledge Focus [Legends]",
                "Requires Knowledge 4",
                "You are an expert on a particular subject.",
                "Select one of the following areas of expertise—alchemy, architecture,\n" +
                        "astronomy, geography, heraldry, history and legends, magic, nature, religion,\n" +
    ...
    public Benefit KnowledgeFocusMagic() {
        return new Benefit("Knowledge Focus [Magic]",
                "Requires Knowledge 4",
                "You are an expert on a particular subject.",
                "Select one of the following areas of expertise—alchemy, architecture,\n" +
                        "astronomy, geography, heraldry, history and legends, magic, nature, religion,\n" +
    ...
    public Benefit KnowledgeFocusNature() {
        return new Benefit("Knowledge Focus [Nature]",
                "Requires Knowledge 4",
                "You are an expert on a particular subject.",
                "Select one of the following areas of expertise—alchemy, architecture,\n" +
                        "astronomy, geography, heraldry, history and legends, magic, nature, religion,\n" +
    ...
    public Benefit KnowledgeFocusReligion() {
        return new Benefit("Knowledge Focus [Religion]",
                "Requires Knowledge 4",
                "You are an expert on a particular subject.",
                "Select one of the following areas of expertise—alchemy, architecture,\n" +
                        "astronomy, geography, heraldry, history and legends, magic, nature, religion,\n" +
    ...
    public Benefit KnowledgeFocusUnderworld() {
        return new Benefit("Knowledge Focus [Underworld]",
                "Requires Knowledge 4",
                "You are an expert on a particular subject.",
                "Select one of the following areas of expertise—alchemy, architecture,\n" +
                        "astronomy, geography, heraldry, history and legends, magic, nature, religion,\n" +
    ...
    public Benefit KeenSenses() {
        return new Benefit("Keen Senses",
    ...
    public Benefit Inspiring() {
        return new Benefit("Inspiring",
                "Requires Warfare 4",
    ...
    public Benefit ImprovedWeaponMastery() {
        return new Benefit("Improved Weapon Mastery",
    ...
    public Benefit ImprovedArmorMastery() {
        return new Benefit("Improved Armor Mastery",
    ...
    public Benefit Heirloom() {
        return new Benefit("Heirloom",
    ...
    public Benefit HeadOfHouse() {
        return new Benefit("Head Of House",
                "none",
    ...
    public Benefit HeadForNumbers() {
        return new Benefit("Head For Numbers",
    ...
    public Benefit Hardy() {
        return new Benefit("Hardy",
    ...
    public Benefit HailOfSteel() {
        return new Benefit("Hail Of Steel",
    ...
    public Benefit Guttersnipe() {
        return new Benefit("Guttersnipe",
                "none",
    ...
    public Benefit Greensight() {
        return new Benefit("Greensight",
                "Requires Will 5",
    ...
    public Benefit GreatHunter() {
        return new Benefit("Great Hunter",
                "Requires Survival 4",
    ...
    public Benefit GiftedTeacher() {
        return new Benefit("Gifted Teacher",
    ...
    public Benefit GiftedAthleteClimb() {
        return new Benefit("Gifted Athlete [Climb]",
    ...
    public Benefit GiftedAthleteJump() {
        return new Benefit("Gifted Athlete [Jump]",
                "Requires Athletics 4",
                "You are in excellent physical shape\n" +
                        "and are skilled in a particular area of Athletics.",
                "Choose one Athletics specialty. When testing Athletics to perform your\n" +
    ...
    public Benefit GiftedAthleteRun() {
        return new Benefit("Gifted Athlete [Run]",
                "Requires Athletics 4",
                "You are in excellent physical shape\n" +
                        "and are skilled in a particular area of Athletics.",
                "Choose one Athletics specialty. When testing Athletics to perform your\n" +
    ...
    public Benefit GiftedAthleteStrength() {
        return new Benefit("Gifted Athlete [Strength]",
                "Requires Athletics 4",
                "You are in excellent physical shape\n" +
                        "and are skilled in a particular area of Athletics.",
                "Choose one Athletics specialty. When testing Athletics to perform your\n" +
    ...
    public Benefit GiftedAthleteSwim() {
        return new Benefit("Gifted Athlete [Swim]",
                "Requires Athletics 4",
                "You are in excellent physical shape\n" +
                        "and are skilled in a particular area of Athletics.",
                "Choose one Athletics specialty. When testing Athletics to perform your\n" +
    ...
    public Benefit GiftedAthleteThrow() {
        return new Benefit("Gifted Athlete [Throw]",
                "Requires Athletics 4",
                "You are in excellent physical shape\n" +
                        "and are skilled in a particular area of Athletics.",
                "Choose one Athletics specialty. When testing Athletics to perform your\n" +
    ...
    public Benefit Furtive() {
        return new Benefit("Furtive",
    ...
    public Benefit FavoredOfSmallfolk() {
        return new Benefit("Favored Of Smallfolk",
                "none",
    ...
    public Benefit FavoredOfNobles() {
        return new Benefit("Favored Of Nobles",
                "none",
    ...
    public Benefit Famous() {
        return new Benefit("Famous",
                "none",
    ...
    public Benefit FaceInTheCrowd() {
        return new Benefit("Face In The Crowd",
    ...
    public Benefit Eloquent() {
        return new Benefit("Eloquent",
    ...
    public Benefit EideticMemory() {
        return new Benefit("Eidetic Memory",
    ...
    public Benefit Dutiful() {
        return new Benefit("Dutiful",
                "Requires Will 4",
    ...
    public Benefit DoubleShot() {
        return new Benefit("Double Shot",
    ...
    public Benefit Dextrous() {
        return new Benefit("Dextrous",
                "none",
    ...
    public Benefit DeftHands() {
        return new Benefit("Deft Hands",
                "Requires Agility 4",
    ...
    public Benefit DeadlyShot() {
        return new Benefit("Deadly Shot",
    ...
    public Benefit DangerSense() {
        return new Benefit("Danger Sense",
                "Requires Awareness 4",
    ...
    public Benefit Courteous() {
        return new Benefit("Courteous",
                "Requires Persuasion 3",
    ...
    public Benefit Connections() {
        return new Benefit("Connections",
    ...
    public Benefit Compelling() {
        return new Benefit("Compelling",
                "Requires Charismatic",
    ...
    public Benefit Cohort() {
        return new Benefit("Cohort",
                "Requires Status 3",
    ...
    public Benefit Charismatic() {
        return new Benefit("Charismatic",
                "Requires Persuasion 3",
    ...
    public Benefit CautiousDiplomat() {
        return new Benefit("Cautious Diplomat",
    ...
    public Benefit Cadre() {
        return new Benefit("Cadre",
    ...
    public Benefit BrotherOfTheNightsWatch() {
        return new Benefit("Brother Of The Night's Watch",
                "none",
    ...
    public Benefit BrawlerIII() {
        return new Benefit("Brawler III",
    ...
    public Benefit BrawlerII() {
        return new Benefit("Brawler II",
    ...
    public Benefit BrawlerI() {
        return new Benefit("Brawler I",
    ...
    public Benefit BraavosiFighterIII() {
        return new Benefit("Braavosi Fighter III",
    ...
    public Benefit BraavosiFighterII() {
        return new Benefit("Braavosi Fighter II",
    ...
    public Benefit BraavosiFighterI() {
        return new Benefit("Braavosi Fighter I",
    ...
    public Benefit BludgeonFighterIII() {
        return new Benefit("Bludgeon Fighter III",
    ...
    public Benefit BludgeonFighterII() {
        return new Benefit("Bludgeon Fighter II",
    ...
    public Benefit BludgeonFighterI() {
        return new Benefit("Bludgeon Fighter I",
    ...
    public Benefit BloodOfTheWildlings() {
        return new Benefit("Blood of the Wildlings",
                "none",
    ...
    public Benefit BloodOfValyria() {
        return new Benefit("Blood of Valyria",
                "none",
    ...
    public Benefit BloodOfTheRhoyne() {
        return new Benefit("Blood of the Rhoyne",
                "none",
    ...
    public Benefit BloodOfTheIronmen() {
        return new Benefit("Blood of the Ironmen",
                "none",
    ...
    public Benefit BloodOfHeroes() {
        return new Benefit("Blood of Heroes",
                "none",
    ...
    public Benefit BloodOfTheFirstMen() {
        return new Benefit("Blood of the First Men",
                "none",
    ...
    public Benefit BloodOfTheAndals() {
        return new Benefit("Blood of the Andals",
                "none",
    ...
    public Benefit Berserker() {
        return new Benefit("Berserker",
                "none",
    ...
    public Benefit Beastfriend() {
        return new Benefit("Beastfriend",
                "none",
    ...
    public Benefit AxeFighterIII() {
        return new Benefit("Axe Fighter III",
                ...
                "Whenever you are armed with an axe and roll a Fighting test to attack\n" +
                        ...
                        "Maimed quality. An opponent may burn a Destiny Point to aBenefit gaining\n" +
                        "this quality");

    }

    public Benefit AxeFighterII() {
        return new Benefit("Axe Fighter II",
    ...
    public Benefit AxeFighterI() {
        return new Benefit("Axe Fighter I",
    ...
    public Benefit Attractive() {
        return new Benefit("Attractive",
                "none",
    ...
    public Benefit ArmorMastery() {
        return new Benefit("Armor Mastery",
                "none",
    ...
    public Benefit Anointed() {
        return new Benefit("Anointed",
                "Requires Sponsor",
    ...
    public Benefit AnimalCohort() {
        return new Benefit("Animal Cohort",
    ...
    public Benefit AdeptNegotiator() {
        return new Benefit("Adept Negotiator",
    ...
    public Benefit AcrobaticDefense() {
        return new Benefit("Acrobatic Defense",
    ...
    public Benefit Accurate() {
        return new Benefit("Accurate",
    ...
    public Benefit Artist() {
        return new Benefit("Artist",
                "none",
